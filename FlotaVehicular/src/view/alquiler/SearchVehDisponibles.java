...
import Modelo.Dao;
import view.alquiler.SearchVehDisponibles;
 ...
 * @author Dani
 */
public class SearchVehDisponibles extends javax.swing.JFrame {
    ...
    public SearchVehDisponibles() {
        initComponents();
          ...
          ip = InetAddress.getLocalHost().getHostAddress() + " - " + InetAddress.getLocalHost().getHostName();
            ...
            Logger.getLogger(SearchVehDisponibles.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//           
       ...
       System.out.println(txtma.getText());
        ...
        dao.mostrarVehiculosDisponibles(codigo,matricula,placa,marca,modelo,"");
...
char cTeclaPresionada=evt.getKeyChar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchVehDisponibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchVehDisponibles().setVisible(true);
            }
        });
    }
