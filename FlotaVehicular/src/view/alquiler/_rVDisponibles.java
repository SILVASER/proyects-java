 ...
 * @author Dani
 */
public class _rVDisponibles extends javax.swing.JFrame {

    /**
     * Creates new form _rVDisponibles
     */
    public _rVDisponibles() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(_rVDisponibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _rVDisponibles().setVisible(true);
            }
        });
    }
  ...
  public void reporte(){
        ...
        try {
            String master = System.getProperty("user.dir") + "/src/Reportes/_rVDisponibles.jasper";
