 ...
 * @author Dani
 */
public class _rVDeAlquiler extends javax.swing.JFrame {

    /**
     * Creates new form _rVDeAlquiler
     */
    public _rVDeAlquiler() {
        initComponents();
...
dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(_rVDeAlquiler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _rVDeAlquiler().setVisible(true);
            }
        });
    }
  ...
  public void reporte(){
        ...
        try {
            String master = System.getProperty("user.dir") + "/src/Reportes/_rVDeAlquiler.jasper";
