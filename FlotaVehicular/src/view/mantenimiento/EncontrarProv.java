 ...
 * @author Dani
 */
public class EncontrarProv extends javax.swing.JFrame {

    /**
     * Creates new form buscarprov
     */
    Dao dao=new Dao();
    public EncontrarProv() {
        initComponents();
        dao.mostrarProveedor5("", "");
    }
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        int filaww = EncontrarProv.tablebuscarp.getSelectedRow();
        try {
            if (filaww == -1) {
                JOptionPane.showMessageDialog(null, "no ha seleccionado ningun registro");
            } else {
                id = (String) EncontrarProv.tablebuscarp.getValueAt(filaww, 0);
                Nombre = (String) EncontrarProv.tablebuscarp.getValueAt(filaww, 2);

                SearchMant.txtidp.setText(id);
                 SearchMant.txtnomp.setText(Nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EncontrarProv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EncontrarProv().setVisible(true);
            }
        });
    }
