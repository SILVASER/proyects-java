 ...
 * @author Dani
 */
public class aOperatividad extends javax.swing.JFrame {

    /**
     * Creates new form aOperatividad
     */
      boolean nuevo=false;
    Dao dao=new Dao();
        ...
        nuevo=true;
							...
							if(nuevo){
								...
								JOptionPane.showMessageDialog(rootPane, resultado);
                                                                 ...
                                                                 dao.mostrarOperatividad(txtid.getText());
                                                                    RegisVehiculos.tableop.setRowSelectionInterval(0, 0); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aOperatividad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new aOperatividad().setVisible(true);
            }
        });
    }
