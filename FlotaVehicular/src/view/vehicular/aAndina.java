 ...
 * @author Dani
 */
public class aAndina extends javax.swing.JFrame {

    /**
     * Creates new form aAndina
     */
        boolean nuevo=false;
    Dao dao=new Dao();
       ...
       nuevo=true;
							...
							if(nuevo){
								...
								JOptionPane.showMessageDialog(rootPane, resultado);
                                                                 ...
                                                                 dao.mostrarAndina(txtid.getText());
                                                                    RegisVehiculos.tableandina.setRowSelectionInterval(0, 0); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aAndina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
