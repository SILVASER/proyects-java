<%-- 
    Document   : bandejaArchivos
    Created on : 14/11/2017, 12:43:43 AM
    Author     : Dani
--%>

<%@page import="Controlador.controlador"%>
<%@page import="Modelo.BandejaArchivos"%>
    ...
    <body onload="tablas();">
        ...
        <table class="table table-hover table-responsive" id="resultado"> 
            ...
            <%  String IdDependencia_Destin = IdDestino;
                ...
                ArrayList<BandejaArchivos> listaDatos = cbe.bandejaArchivos(IdDependencia_Destin, IdPersona);
                
                for (int i = 0; i < listaDatos.size(); i++) {
            %>
            <tr class="letra">
                <%
                    BandejaArchivos b = (BandejaArchivos) listaDatos.get(i);
